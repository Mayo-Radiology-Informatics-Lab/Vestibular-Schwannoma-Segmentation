...
if __name__ == "__main__":
    # Create the args namespace programmatically
    args = argparse.Namespace()

    # Set the values programmatically (instead of parsing from the command line)
    args.checkpoint = None
    args.logdir = "./runs/test"
    args.pretrained_dir = "/research/projects/Sahika/research-contributions/UNETR/BTCV/pretrained_models/pretrained_models/"
    args.data_dir = "/research/projects/Sahika/research-contributions/UNETR/BTCV/dataset/"
    args.json_list = "/research/projects/Sahika/research-contributions/UNETR/BTCV/dataset/Dataset465_SCHWANNOMA12_3xDice_R030310C7_CD2/dataset_schwannoma12_465.json"
    args.pretrained_model_name = "UNETR_model_best_acc.pth"
    ...
    args.pos_embed = "perceptron"
    args.norm_name = "instance"
    args.num_heads = 12
    args.mlp_dim = 3072
    ...
    # Set AMP based on noamp flag
    args.amp = not args.noamp
    args.logdir = "./runs/" + args.logdir

    # If you want to simulate distributed training, set distributed to True
    if args.distributed:
        args.ngpus_per_node = torch.cuda.device_count()
        print("Found total gpus", args.ngpus_per_node)
        args.world_size = args.ngpus_per_node * args.world_size
        ...
        # Call the main_worker directly with GPU 0 and the hard-coded arguments
        main_worker(gpu=0, args=args)